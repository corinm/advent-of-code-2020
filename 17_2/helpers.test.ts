...
describe("surroundingCells", () => {
  test("works", () => {
    ...
    expect(cells).toContainEqual({ w: -1, x: -1, y: -1, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 0, y: -1, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: -1, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: -1, y: 0, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 0, y: 0, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: 0, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: -1, y: 1, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 0, y: 1, z: -1 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: 1, z: -1 });

    expect(cells).toContainEqual({ w: -1, x: -1, y: -1, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: 0, y: -1, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: -1, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: -1, y: 0, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: 0, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: -1, y: 1, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: 0, y: 1, z: 0 });
    expect(cells).toContainEqual({ w: -1, x: 1, y: 1, z: 0 });
...
describe("solvePart2", () => {
  test("example", () => {
    ...
    expect(solvePart2(grid)).toEqual(112);
  });
});
